...
class PokerHand
  ...
  def four_of_a_kind?
    only_values.tally.values.count(4) == 1
  end
  ...
  def flush?
    only_suits.tally.values.count(5) == 1
  end

  def straight?
    sorted = only_values.sort
    (sorted.first..sorted.last).to_a == sorted.uniq
  end

  def three_of_a_kind?
    only_values.tally.values.count(3) == 1
  end

  def two_pair?
    only_values.tally.values.count(2) == 2
  end

  def pair?
    only_values.tally.values.count(2) == 1
  end
end
